...
//         // Clear any client-side storage if used (optional)
//         localStorage.removeItem("accessToken"); // If you store tokens in localStorage
//         sessionStorage.removeItem("accessToken"); // If you store tokens in sessionStorage
//         navigate("/"); // Redirect to login page
//       }
//     } catch (error) {
//       console.error("Logout error:", error);
//       // Redirect even if there's an error to ensure user is logged out
//       navigate("/");
//     }
//   };
