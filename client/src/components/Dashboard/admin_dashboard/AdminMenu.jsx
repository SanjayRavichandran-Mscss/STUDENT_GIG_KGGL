...
//                 >
//                   <svg className="w-5 h-5 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4រឆ្នោះ 4 4 0 018 0z"/>
//                   </svg>
  ...
  return (
   ...
   <li>
                ...
                >
                  ...
                  Ledger
                  <svg
                    className={`w-4 h-4 ml-auto transform ${isLedgerOpen ? "rotate-180" : ""}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <ul className="ml-6 space-y-1">
                    <li>
                      <Link
                        ...
                        onClick={() => setIsMenuOpen(false)}
                      >
                        <ArrowDownLeft className="w-4 h-4 mr-3 text-green-600" />
                        Receivable
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        onClick={() => setIsMenuOpen(false)}
                      >
                        <ArrowUpRight className="w-4 h-4 mr-3 text-orange-400" />
                        Payable
                      </Link>
                    </li>
                  </ul>
