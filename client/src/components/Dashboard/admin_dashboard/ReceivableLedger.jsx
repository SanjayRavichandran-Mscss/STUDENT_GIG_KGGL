...
//               <a href={`http://localhost:5000/${transaction.transaction_screenshot}`} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">
//                 View
//               </a>
//             ) : 'N/A'}
//           </div>,
...
//     MySwal.fire({
//       imageUrl: `http://localhost:5000/${screenshotPath}`,
            ...
            {transaction.transaction_screenshot && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <img 
                      src={`http://localhost:5000/${transaction.transaction_screenshot}`} 
