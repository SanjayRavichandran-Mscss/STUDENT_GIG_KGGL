...
export default function StudentRefer() {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const response = await fetch('https://gig.kggeniuslabs.com/apiapi/admin/getallprojects-studentrequired');
        if (!response.ok) {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      const response = await axios.post('https://gig.kggeniuslabs.com/apiapi/admin/send-referral-mail', {
        to,
        subject,
        body,
      });
