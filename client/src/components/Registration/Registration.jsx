...
export function Registration() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const collegeRes = await axios.get("https://gig.kggeniuslabs.com/api/api/college/getcollege");
  ...
  useEffect(() => {
    if (selectedCategory) {
      axios
        .get(`https://gig.kggeniuslabs.com/api/api/college/course/${selectedCategory}`)
        .then((res) => {
  ...
  useEffect(() => {
    if (selectedCollege) {
      axios
        .get(`https://gig.kggeniuslabs.com/api/api/college/years/${selectedCollege}`)
        .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://gig.kggeniuslabs.com/api/api/stu/registration", payload);
