...
//       try {
//         const response = await fetch(`https://gig.kggeniuslabs.com/apiapi/stu/getBidCredits/${decodedId}`, {
//           method: "GET",
//           headers: {
...
//             try {
//                 setLoading(true);
//                 const response = await axios.get(`https://gig.kggeniuslabs.com/apiapi/stu/student-test-data/${decodedId}`);
//                 setData(response.data);
//                 const testsResponse = await axios.get(
//                     `https://gig.kggeniuslabs.com/apiapi/test/all-tests/${decodedId}`,
