...
//         console.log(response.data.studentperformance);
...
//   const calculateAdjustedAttended = (result) => {
//     let beginnerAttended = parseInt(result.performance.easy_attended || "0");
//     let intermediateAttended = parseInt(result.medium_attended || "0");
//     const advancedAttended = parseInt(result.hard_attended || "0");
...
//     // If advanced attended is 0, add 4 to beginner
//     if (advancedAttended === 0) {
//       intermediateAttended += 4;
//     }

//     return beginnerAttended , intermediateAttended;
...
//               const adjustedBeginnerAttended = calculateAdjustedAttended(result);
...
//                                   {result.easy_score ?? "0"}
//                                   <span className="text-sm font-normal text-green-500"> / {adjustedBeginnerAttended}</span>
//                                 </p>
//                               </div>
