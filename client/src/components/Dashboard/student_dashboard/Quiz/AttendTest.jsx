...
export default function AttendTest() {
  ...
  useEffect(() => {
    const fetchTest = async () => {
      try {
        ...
        // Filter for the specific test by test_id and test_type
  ...
  }, [test, correctCounts, determineStudentLevelAndPercentage, answers, studentId, id, navigate]);
  ...
  if (!test) {
    return (
      <div className="max-w-4xl mx-auto py-8 px-4">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Loading Test...</h1>
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">{test.test_name}</h1>
