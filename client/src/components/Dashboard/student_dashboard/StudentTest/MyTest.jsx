...
export default function MyTest() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const testsResponse = await axios.get(
          `https://gig.kggeniuslabs.com/apiapi/test/active-tests/${studentId}`,
        ...
        const schedulesResponse = await axios.get(
          `https://gig.kggeniuslabs.com/apiapi/test/schedules/${studentId}`,
          { withCredentials: true }
        );
        ...
        const attendedResponse = await axios.get(
          `https://gig.kggeniuslabs.com/apiapi/test/student-test-attended/${studentId}`,
          { withCredentials: true }
        );
  ...
  const handleDateTimeChange = async (testId, date) => {
    ...
    try {
      ...
      await axios.post(
        "https://gig.kggeniuslabs.com/apiapi/test/schedule",
        {
