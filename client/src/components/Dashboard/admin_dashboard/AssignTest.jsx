    ...
    const fetchData = async () => {
      ...
      try {
        const [testsResponse, questionsResponse, skillsResponse, levelsResponse] = await Promise.all([
          axios.get("https://gig.kggeniuslabs.com/api/api/test/tests", { withCredentials: true }),
          axios.get("https://gig.kggeniuslabs.com/api/api/test/available-questions", { withCredentials: true }),
          axios.get("https://gig.kggeniuslabs.com/api/api/test/skills", { withCredentials: true }),
          axios.get("https://gig.kggeniuslabs.com/api/api/test/difficulty-levels", { withCredentials: true }),
        ]);
  ...
  const handleToggleStatus = async (testId, currentStatus) => {
    try {
      ...
      const response = await axios.post(
        "https://gig.kggeniuslabs.com/api/api/test/toggle-test-status-skill-based",
