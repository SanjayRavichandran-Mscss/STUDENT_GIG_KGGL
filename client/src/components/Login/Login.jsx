...
//     try {
//       const response = await axios.post("https://gig.kggeniuslabs.com/apiapi/stu/login", {
//         email,
//         password,
//       });
...
//         try {
//           const techRes = await axios.get(`https://gig.kggeniuslabs.com/apiapi/stu/technical-status/${email}`);
