...
//     setIsLoading(true);
//     axios
//       .get("https://gig.kggeniuslabs.com/apiapi/college/skill")
//       .then((res) => {
...
//   useEffect(() => {
//     axios
//       .get("https://gig.kggeniuslabs.com/apiapi/test/difficulty-levels")
//       .then((res) => {
//         setLevels(res.data);
//       })
//       .catch(() => {
...
//     setIsLoading(true);
//     axios
//       .post(`https://gig.kggeniuslabs.com/apiapi/admin/addproject`, {
//         pname,
//         pdes,
//         skill,
//         date,
