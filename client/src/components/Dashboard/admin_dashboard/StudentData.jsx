...
function StudentsData() {
  ...
  const studentsWithSkills = studentData.filter(student => 
    student.skills && student.skills.length > 0
  ).length;
  const studentsWithoutSkills = totalStudents - studentsWithSkills;
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
  <div className="bg-white border border-gray-200 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
    <h3 className="text-base font-semibold text-gray-800 mb-1">Total Students</h3>
  ...
  <div className="bg-white border border-gray-200 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
    <h3 className="text-base font-semibold text-gray-800 mb-1">Students With Skills</h3>
    <p className="text-2xl font-bold text-teal-700">{studentsWithSkills}</p>
    <p className="text-xs text-gray-500 mt-1">Students with at least 1 skill</p>
  </div>
  <div className="bg-white border border-gray-200 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
    <h3 className="text-base font-semibold text-gray-800 mb-1">Students Without Skills</h3>
    <p className="text-2xl font-bold text-gray-700">{studentsWithoutSkills}</p>
    <p className="text-xs text-gray-500 mt-1">Students with no skills listed</p>
  </div>
</div>
